    ...
    return (
        <div className="projects">
            <div className="first-project">
                <p>This was my first ever project. A simple rock paper scissors game <br/>
            ...
            <div className = "second-project">
                <p>My second project really introduced the speed and efficiency of React <br/>
                   into my tech skills. Even though DOM manipulation can create almost anything <br/>
                   on the web, using React can make a webpage faster, quicker and easier to <br/>
            ...
            <div className = "third-project">
                <p> The third project I'm currently working on is a weather mood tracker. The <br/>
                    idea for this project sort of evolved over time and after discovering weather<br/>
                    mood trackers on Etsy, I decided I want to create a digital weather mood tracker.<br/>
                    There are still a few kinks to work on, but the app has a backend portion that <br/>
